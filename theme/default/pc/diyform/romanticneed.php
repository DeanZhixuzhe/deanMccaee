...
<title>专属定制求婚_免费求婚方案_求婚策划方案获取_浪漫求婚策划方案提供 - TheOne浪漫策划公司</title>
...
<div class="romanticneed body pt030">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">浪漫场地</label>
        <div class="col-sm-10">
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="广场">广场</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="公园">公园</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="沙滩">沙滩</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="餐厅">餐厅</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="酒店">酒店</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="酒吧">酒吧</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="电影院">电影院</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="咖啡厅">咖啡厅</label>
            <label class="checkbox-inline"><input type="checkbox" name="theme" value="KTV">KTV</label>
        </div>
    </div>
	<div class="form-group">
