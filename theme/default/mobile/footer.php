...
<div id="footer">
    <ul class="am-avg-sm-4">
        <li class="active">
            <a href="{$Think.config.website.domain}">
        ...
        <li>
            <a href="/mall/" rel="nofollow">
                <img src="__STATIC__/{$Think.config.website.view_style}/m/images/icon-footer2-a.png"/>
                <p>商城</p>
            </a>
        </li>
        <li>
            <a href="{:url('index/Diyform/index','diyform=romanticneed')}" rel="nofollow" rel="nofollow">
                <img src="__STATIC__/{$Think.config.website.view_style}/m/images/icon-footer2-a.png"/>
                <p>定制</p>
            </a>
        </li>
    ...
    <div class="wxsb">
        <p>微信中长按图片识别二维码</p>
        <img src="__STATIC__/{$Think.config.website.view_style}/images/wechat@linda_1.jpg">
        <p>或者复制微信号加好友</p>
