...
<div id="header_s">
    <div class="logo">
        <a href="{$Request.domain}/"><img src="__STATIC__/{$Think.config.website.view_style}/images/Logo_0101.png"></a>
    </div>
    <span>攻略详情</span>
    <div class="nav">
...
<div id="news_detail">
    <div class="cover" style="background-image: url(http://img1.1314theone.com{$data.litpic});">
        ...
        <div class="read">
            <img class="eye " src="__STATIC__/{$Think.config.website.view_style}/m/images/read.png">
