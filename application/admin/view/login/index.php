...
<div class="m-login">
    ...
    <form id="login-form" action="{:Url('login/index')}" method="post" role="form">

        <div  class="form-input">
            <div class="form-group field-loginform-username required">

                <input type="text" class="form-control" name="username" maxlength="256" placeholder="用户名" value="">
            </div>
            <div class="form-group field-loginform-password required">
                <input type="password" id="loginform-password" class="form-control" name="password" maxlength="256" placeholder="密码">
